...
`prepTumor.svprepScript`|String|"java  -Xmx~{memory - overhead}G -jar $HMFTOOLS_ROOT/svprep.jar"|path to the pre-processing script
...
`prepNormal.svprepScript`|String|"java  -Xmx~{memory - overhead}G -jar $HMFTOOLS_ROOT/svprep.jar"|path to the pre-processing script
